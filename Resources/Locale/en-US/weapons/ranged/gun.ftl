...
gun-set-fire-mode-popup = Changed to {$mode} # Aurora's Song - Firemode Refactor, literally just added -popup to make it compatible with BatteryWeaponFireModesSystem
